    ...
    <div style={{ border: '1px solid #1e1e1e', borderRadius: 12, background: '#0a0a0a', overflow: 'hidden', marginBottom: 16 }}>
      ...
      <div style={{ padding: 16 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          ...
          <div style={{ gridColumn: '1 / -1' }}>{field('Solana Address', 'address', 'AbcDef...')}</div>
          <div style={{ gridColumn: '1 / -1' }}>{field('pump.fun URL', 'pumpfun_url', 'https://pump.fun/coin/...')}</div>
...
export default function Admin() {
  ...
  const addAd = useCallback(() => {
    setAds((prev) => [
      ...prev,
      { image: '', badge: 'SPONSORED', title: 'New Ad', desc: 'Description', link: '', accent: '#FF6A00', active: true },
    ]);
  }, []);
    ...
    <div style={{ minHeight: '100vh', background: '#060606', fontFamily: 'Inter, sans-serif', color: '#fff' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 24px' }}>
        <div style={{ marginBottom: 40 }}>
          <div style={{ marginBottom: 20 }}>
            ...
            <p style={{ fontSize: 13, color: '#555', margin: 0 }}>
              Controls the token info shown on the landing page: nav badge, token section heading, description, and buy link.
            </p>
          </div>
          <TokenConfigSection token={token} setToken={setToken} onSave={saveToken} saving={savingToken} />
        </div>
        ...
        {fetching && ads.length === 0 && (
          <div style={{ textAlign: 'center', color: '#333', padding: '80px 0', fontSize: 14 }}>Loading ads...</div>
        )}
        ...
        {!fetching && ads.length === 0 && (
          ...
          >
            <div style={{ fontSize: 36, marginBottom: 10 }}>ADS</div>
...
const GLOBAL_CSS = `
  ...
  * { box-sizing: border-box; }
  body { margin: 0; }
  input:focus, textarea:focus { border-color: #FF6A00 !important; }
`;
